...
function Projects() {
  return (
    <main className="text-white flex justify-center flex-col text-center px-[20v] py-20" id="Projects">
          ...
          <li className="flex flex-col justify-between hover:bg-blue-950 mx-[10vw] lg:mx-[20vw] rounded-xl py-2 px-3 bg-[#0a1331] my-10 transition duration-500 hover:scale-105">
            <div>
              <img
                src={Reference}
                alt=""
                className="h-[30vh] w-[75vw] rounded-lg lg:h-[60vh] lg:w-[60vw] opacity-80 hover:opacity-100"
              />
            </div>
            <div className="flex flex-row">
              <div className="lg:max-w-[40vw]">
                ...
                <p className="text-[12px] lg:text-sm text-blue-300 text-start mt-1 mb-3">
                  Shoooz is an online platform dedicated to offering a seamless
                  shoe shopping experience. Users can easily discover a wide
                  range of shoes, manage their shopping activities, and provide
